...
import { CircuitBreakerService, CircuitBreakerStats } from '../../../core/infrastructure/resilience/circuit-breaker.service';
...
@Component({
      ...
      <div class="monitor-grid">
            ...
            <div *ngFor="let agent of agents" 
              ...
              <div class="agent-header">
                ...
                <span class="agent-status" 
                      [class.active]="agent.isRunning">
                  {{ agent.state }}
                </span>
              </div>
              <div class="agent-details">
                <p><strong>ID:</strong> {{ agent.id }}</p>
                <p *ngIf="agent.lastActivity">
        ...
        <section class="monitor-section circuit-breakers-section">
          ...
          <div class="circuit-breaker-list">
            <div *ngFor="let cb of circuitBreakers | keyvalue" 
            ...
            <div *ngIf="(circuitBreakers | keyvalue).length === 0" 
                 class="empty-state">
          ...
          <div class="metrics-list">
            <div *ngFor="let metric of metrics | keyvalue" 
              ...
              <div class="metric-stats">
                ...
                <div class="metric-stat" *ngIf="metric.value.p95">
                  <span>P95:</span>
                  <span>{{ metric.value.p95 | number:'1.2-2' }}</span>
                </div>
              </div>
            </div>
            <div *ngIf="(metrics | keyvalue).length === 0" 
                 class="empty-state">
        ...
        <section class="monitor-section audit-logs-section">
          ...
          <div class="audit-log-list">
            <div *ngFor="let log of recentAuditLogs" 
              ...
              <div class="log-details">
                ...
                <p *ngIf="log.errorMessage" class="error-message">
                  <strong>Error:</strong> {{ log.errorMessage }}
                </p>
              </div>
            </div>
            <div *ngIf="recentAuditLogs.length === 0" 
                 class="empty-state">
              No audit logs
            </div>
          </div>
        ...
        <section class="monitor-section event-bus-section">
          ...
          <div class="event-stats">
            <div class="stat-card">
              <h3>By Type</h3>
              <div class="stat-list">
                <div *ngFor="let type of eventBusStats.byType | keyvalue" 
                     class="stat-item">
                  <span>{{ type.key }}:</span>
            ...
            <div class="stat-card">
              <h3>By Source</h3>
              <div class="stat-list">
                <div *ngFor="let source of eventBusStats.bySource | keyvalue" 
                     class="stat-item">
            ...
            <div class="stat-card">
              <h3>By Priority</h3>
              <div class="stat-list">
                <div *ngFor="let priority of eventBusStats.byPriority | keyvalue" 
                     class="stat-item">
  ...
  styles: [`
    ...
    .agent-card, .circuit-breaker-card, .metric-card {
      padding: 15px;
    ...
    .agent-header h3, .cb-header h3, .metric-card h3 {
      margin: 0;
      font-size: 16px;
      color: #333;
    }
