...
export class NavigationComponent {
  ...
  /**
   * True when the current route is the kiosk experience (/kiosk or /kiosk/shop).
   * The navigation chrome must not appear there — it is a customer-facing screen.
   */
